...
class Kosmos2LMWrapper(nn.Module):
...
class Kosmos2PreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, Kosmos2VisionEmbeddings):
            ...
            nn.init.normal_(module.text_model.lm_head.weight, std=std)
            if module.text_model.lm_head.bias is not None:
                module.text_model.lm_head.bias.data.zero_()
